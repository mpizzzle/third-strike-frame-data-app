...
public class ShowSpecialsDetailActivity extends ActionBarActivity {
    private ShowSpecialsDetailActivity ref = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int specialId = getIntent().getIntExtra(ResourceHelper.ResourceIds.SPECIAL_ID.name(), 0);
        ...
        if (charSDO != null) {
            SpecialSDO actionSDO = charSDO.specials.get(specialId);
            if(actionSDO != null){
                ...
                ((TextView)findViewById(R.id.detail_bgs_wiff)).setText(actionSDO.bar_gain_self.wiff + "");
                ((TextView)findViewById(R.id.detail_bgs_hit)).setText(actionSDO.bar_gain_self.hit + "");
                ((TextView)findViewById(R.id.detail_bgs_block)).setText(actionSDO.bar_gain_self.block + "");
